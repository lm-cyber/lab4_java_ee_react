    ...
    return (
        ...
        <form className="centered">
            ...
            <div className="input-container">
                <CustomButton data-test-id="login-button" label="Login" onClick={handleSubmit(handleLogin)}/>
                <CustomButton data-test-id="register-button" label="Register" onClick={handleSubmit(handleRegister)}/>
            </div>
        </form>
        </section>
    );
